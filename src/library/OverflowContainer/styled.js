...
export const OverflowContainer = createStyledComponent(
  'div',
...
export const OverflowContainerWithShadows = createStyledComponent(
  'div',
  (props) => {
...
export const OverflowContainerWithShadowsScroller = createStyledComponent(
