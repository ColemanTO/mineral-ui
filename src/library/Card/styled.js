...
export const Card = createStyledComponent(
  'div',
  (props) => {
...
export const CardActions = createStyledComponent(
  CardRow,
  (props) => {
    const theme = {
...
export const CardBlock = createStyledComponent(
  CardRow,
  (props) => {
    const theme = cardTheme(props.theme);
...
export const CardDivider = createStyledComponent(
  'div',
  (props) => {
    const theme = {
...
export const CardImage = createStyledComponent(
  'img',
  (props) => {
    const theme = cardTheme(props.theme);
...
export const CardStatus = createStyledComponent(
  CardRow,
