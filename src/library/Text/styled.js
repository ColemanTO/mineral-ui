...
import type { TextProps, TextTheme } from './types';
...
type GetTextStyles = (inherit: ?boolean) => Styles;
...
const getTextStyles: GetTextStyles = (inherit) => {
  return inherit
...
export const createRootNode: CreateRootNode<TextProps> = (props) => {
  ...
  return createStyledComponent(element, getTextStyles(inherit), {
    rootEl: element,
